...
const navDict = {
  ...
  Nested: {
    file: "nested-routes",
    children: {
      "Nested Route Example": { file: "nested-route-example" },
    },
  },
  "Route Example": { file: "route-example" },
};
const fileNameLookup = {
  index: "Introduction",
  "nested-routes": "Nested",
  "nested-route-example": "Nested Route Example",
    ...
    <>
      <div className="flex justify-center bg-neutral-50 ">
        <div className="w-full overflow-hidden flex flex-col max-w-[1536px]">
          <PageSEO title={"Project Docs"} description={"Project Docs"} />
                  ...
                  {navDict[item].children && (
                    <div className="flex flex-col items-start justify-start ml-4">
                      {Object.keys(navDict[item].children).map((child) => (
                        <Link
                          key={child}
                          href={`/${navDict[item].children[child].file}`}
